...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 px-4 md:px-6 py-2">
      {/* Upper Tier: Contact & Socials */}
      <div className="max-w-7xl mx-auto mb-2 flex justify-between items-center px-4 py-1.5 glass rounded-xl text-[10px] md:text-xs font-bold tracking-wider text-gray-400 border-white/5">
        <div className="flex gap-4 md:gap-6">
          <a href="mailto:medancityug@gmail.com" className="flex items-center gap-2 hover:text-accent transition-colors">
            <Mail size={12} className="text-accent" />
            <span className="hidden sm:inline">medancityug@gmail.com</span>
          </a>
          <a href="tel:+256758611414" className="flex items-center gap-2 hover:text-accent transition-colors">
            <div className="h-3 w-3 rounded-full bg-accent/20 flex items-center justify-center">
